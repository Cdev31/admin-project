...
-- Cambiar al modelo de recuperación COMPLETO (Full Recovery Model)
-- Esto es OBLIGATORIO para poder hacer backups de logs de transacciones
ALTER DATABASE Gym_DB 
SET RECOVERY FULL;
GO

-- Definición de variables para el nombre dinámico del archivo
...
WITH 
    COMPRESSION,
    NO_TRUNCATE, -- Asegura que se guarde el log incluso si la BD está dañada
    NAME = @nombreBackup,
    STATS = 10;
GO